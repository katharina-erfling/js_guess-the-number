var JSConfetti = (function () {
    ...
    return i(
      function i(e) {
        ...
        var n = e.initialPosition,
          ...
          u = e.emojiSize,
          l = e.canvasWidth,
          f = e.initialFlightAngle,
          d = e.rotationAngle,
          v = e.shouldHideConfettiInShiftedPosition,
          m = void 0 !== v && v,
          p = o(0.9, 1.7, 3) * r(l);
        ((this.confettiSpeed = { x: p, y: p }),
          (this.finalConfettiSpeedX = o(0.2, 0.6, 3)),
          (this.rotationSpeed = c.length ? 0.01 : o(0.03, 0.07, 3) * r(l)),
          (this.dragForceCoefficient = o(5e-4, 9e-4, 6)),
          (this.radius = { x: a, y: a }),
          (this.initialRadius = a),
          ...
          (this.sin = Math.sin(f)));
        var y = o(-150, 0);
        ((this.positionOffset = { x: y * this.sin, y: y * this.cos }),
          (this.distanceTravelled = { x: 0, y: 0 }));
        var g = {
          x: n.x + this.positionOffset.x,
          y: n.y - this.positionOffset.y,
        };
        ((this.currentPosition = Object.assign({}, g)),
          (this.initialPosition = Object.assign({}, g)),
          (this.color = c.length ? null : s(h)),
          (this.emoji = c.length ? s(c) : null),
      ...
      [
        ...
        },
        {
          ...
          value: function (t, i) {
            ...
            var h = this.currentPosition.y,
              c = i - r;
            this.currentPosition.y =
              this.initialPosition.y -
              e.y * this.cos * c +
              (0.00125 * Math.pow(c, 2)) / 2;
            var u = { x: e.x * this.sin * t, y: this.currentPosition.y - h };
            ((this.currentPosition.x += u.x),
              (this.distanceTravelled.x += Math.abs(u.x)),
              (this.distanceTravelled.y += Math.abs(u.y)),
              this.distanceTravelled.x >= Math.abs(this.positionOffset.x) &&
                this.distanceTravelled.y >= Math.abs(this.positionOffset.y) &&
                (this.isVisible = !0),
  ...
  function c(t) {
    var i = t.confettiRadius,
      e = void 0 === i ? 6 : i,
      n = t.confettiNumber,
      o = void 0 === n ? t.confettiesNumber || (t.emojis ? 40 : 250) : n,
      s = t.confettiColors,
      r = void 0 === s ? a : s,
      h = t.emojis,
          ...
          },
          {
            ...
            value: function (t, i, e) {
              ...
              this.shapes = this.shapes.filter(function (t) {
                return (
                  t.updatePosition(o, s),
                  t.draw(n.canvasContext),
                  !e || t.getIsVisibleOnCanvas(i)
                );
              });
            },
          },
      ...
      return i(
        function i() {
          ...
          (t(this, i),
            ...
            (this.canvas =
              n.canvas ||
              (((e = document.createElement("canvas")).style.position =
                "fixed"),
              (e.style.width = "100%"),
              (e.style.height = "100%"),
              (e.style.top = "0"),
            ...
            value: function () {
              for (
                var t = c(
                  ...
                  o = t.emojis,
                  s = t.emojiSize,
                  a = t.confettiDispatchPosition,
                  r = this.canvas.getBoundingClientRect().width,
                  u = new p(this.canvasContext),
                  l = 0;
                l < e;
                l++
              ) {
                var f = new h({
                  ...
                  canvasWidth: r,
                  rotationAngle: v(),
                  initialFlightAngle: d(),
                  shouldHideConfettiInShiftedPosition: !0,
                });
                u.addShapes(f);
              }
              return (
                this.activeConfettiBatches.push(u),
                this.queueAnimationFrameIfNeeded(),
                u.getBatchCompletePromise()
              );
            },
          },
          {
